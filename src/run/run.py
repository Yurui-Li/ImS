...
def get_agent_own_state_size(env_args):
    sc_env = StarCraftCapabilityEnvWrapper(**env_args)
...
def run_sequential(args, logger):
    ...
    if args.env == "sc2" or args.env == "sc2wrapped":
        args.unit_dim = get_agent_own_state_size(args.env_args)
    elif args.env == "gfootball":
        args.unit_dim = 44 # 22 (x,y) coordinates of left team players 22 - (x,y) direction of left team players
    args.obs_shape = env_info["obs_shape"]

    if getattr(args, 'agent_own_state_size', False):
        args.agent_own_state_size = get_gfootball_state_size(args.env_args)
